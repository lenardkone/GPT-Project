...
def submit():
    ...
    completion = openai.ChatCompletion.create(
        ...
        temperature=0.8,
        messages=[
            {"role": "system", "content": "Pretend to be a therapist for the Application called 'MindRealm' & Generate a creative and emotive 600 word long ssml script for a meditation routine based on how the user is feeling. It should include varied break times and vivid visualisations about the topic. The breaks should be placed realistically in a natural soothing manner. Only respond to prompts that include feelings & topics suitable for meditation and say examples if the prompt does not fit. Every response like error & welcome messages should also be in ssml format.  Set the volume to 'soft' and rate to '75%'."},
