...
def submit():
    ...
    model="gpt-3.5-turbo",
    messages=[
        {"role": "system", "content": "Generate a creative and emotive ssml script for a meditation routine with breathing exercises based on how the user is feeling. It should include varied break times and vivid visualisations about the topic. Only respond to prompts that include feelings."},
